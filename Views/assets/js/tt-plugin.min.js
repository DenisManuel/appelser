...
var versatile_popup_TTversatilePopup = function () {
  function TTversatilePopup() {
    ...
    this.backgroundImage = options.backgroundImage || false;
    this.small = options.small || false;
    this.med = options.med || false;
  ...
  versatile_popup_createClass(TTversatilePopup, [{
    ...
    value: function init() {
      ...
      src(src(this.$widget).find('.nothanks')).on('click', function () {
        _this.hide();
      });
